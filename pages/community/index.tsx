    ...
    <div className='px-4 py-16 space-y-8'>
      {[1, 2, 3, 4, 5, 6].map((_, index) => (
        <div key={index} className='flex flex-col items-start cursor-pointer'>
          ...
          <div className='flex mt-3 space-x-5 text-gray-700 py-2.5 border-t border-b-[2px] w-full'>
      ...
      <button
        type='button'
        className='fixed p-3 text-white transition-all bg-orange-400 rounded-full shadow-xl cursor-pointer bottom-5 right-5 hover:bg-orange-500'
      >
        <svg
          className='w-6 h-6'
          fill='none'

...
const StreamDetail: NextPage = () => {
  return (
    <div className='px-4 py-10 space-y-4'>
      ...
      <b className='block mt-2 text-2xl font-semibold text-gray-800 cursor-default'>
        Let&apos;s try potatos
      </b>
      <div className='pb-16 h-[50vh] overflow-y-auto py-10 space-y-4'>
      ...
      <div className='fixed inset-x-0 w-full max-w-md mx-auto bottom-4'>
        <div className='relative flex items-center'>
          <input
            type='text'
            className='w-full pr-12 border-gray-300 rounded-full shadow-sm focus:ring-orange-400 focus:outline-none focus:border-orange-500'
          />

...
export default function Layout({
  ...
  return (
    <div>
      ...
      <div className={classNames('pt-12', { 'pb-24': hasTabBar })}>
        {children}
      </div>
      {hasTabBar ? (
        <nav className='fixed bottom-0 flex justify-between w-full max-w-xl px-10 pt-3 pb-5 text-xs text-gray-700 bg-white border-t'>
          <Link href='/'>
            <a
              className={classNames('flex flex-col items-center space-y-2 ', {
                'text-orange-500': router.pathname === '/',
          ...
          <Link href='/community'>
            <a
              className={classNames('flex flex-col items-center space-y-2 ', {
                'text-orange-500': router.pathname === '/community',
                'hover:text-gray-500 transition-colors':
          ...
          <Link href='/chats'>
            <a
              className={classNames('flex flex-col items-center space-y-2 ', {
                'text-orange-500': router.pathname === '/chats',
                'hover:text-gray-500 transition-colors':
          ...
          <Link href='/stream'>
            <a
              className={classNames('flex flex-col items-center space-y-2 ', {
                'text-orange-500': router.pathname === '/stream',
                'hover:text-gray-500 transition-colors':
          ...
          <Link href='/profile'>
            <a
              className={classNames('flex flex-col items-center space-y-2 ', {
                'text-orange-500': router.pathname === '/profile',
                'hover:text-gray-500 transition-colors':
